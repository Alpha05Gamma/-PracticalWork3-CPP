...
Создать любую структуру минимум с 5 атрибутами отсортировать её по asc (сортировка по возрастанию) и desc (сортировка по убыванию) по любому атрибуту.
Вывести минимум 5 записей данной структуры.
На оценку 4:

Создайте класс "Автомобиль" (Car), который имеет следующие свойства и методы:
Свойства:
...
Создайте класс "Грузовик" (Truck), который наследует свойства и методы класса "Автомобиль", и имеет дополнительные свойства и методы:
...
Создать функцию для сортировки автомобилей и грузовиков по параметру код выпуска с выбором сортировки asc (сортировка по возрастанию) и desc (сортировка по убыванию) и вывести данные.
Создать функцию для сортировки автомобилей и грузовиков по параметру скорость с выбором сортировки asc (сортировка по возрастанию) и desc (сортировка по убыванию) и вывести данные.
Создать функцию для поиска автомобилей по марке и модели.
Так же добавить минимум два атрибута и метода в каждый класс. Постараться сделать так чтобы атрибуты и методы не повторялись
